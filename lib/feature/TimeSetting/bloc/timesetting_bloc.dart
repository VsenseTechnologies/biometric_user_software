...
class TimeFormBloc extends Bloc<TimeFormEvent, TimeFormState> {
  ...
  Future<http.Response> _submitTimeRangesToServer() async {
    ...
    Map<String, dynamic> timeData = {
      "user_id": userId,
      "morning_start": _formatTimeWithDate(morningStartTime),
      "morning_end": _formatTimeWithDate(morningEndTime),
      "afternoon_start": _formatTimeWithDate(afternoonStartTime),
      "afternoon_end": _formatTimeWithDate(afternoonEndTime),
      "evening_start": _formatTimeWithDate(eveningStartTime),
      "evening_end": _formatTimeWithDate(eveningEndTime),
    };
